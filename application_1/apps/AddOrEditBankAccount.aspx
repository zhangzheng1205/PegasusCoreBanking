                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <div class="row">
                                                <div class="col-lg-2">
                                                    <input type="button" class="btn btn-success" value="Start capture" onclick="startCapture()" />
                                                </div>
                                                <div class="col-lg-2"></div>
                                                <div class="col-lg-2">
                                                    <input type="button" class="btn btn-primary" value="Take Picture" onclick="takePhoto()" />
                                                </div>
                                                <div class="col-lg-2"></div>
                                                <div class="col-lg-2">
                                                    <input type="button" class="btn btn-danger" value="Upload" onclick="upload()" />
                                                </div>
                                                <div class="col-lg-2"></div>
                                            </div>
                                        </div>
