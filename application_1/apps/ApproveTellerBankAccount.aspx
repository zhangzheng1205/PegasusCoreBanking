<%@ Page Language="C#" MasterPageFile="~/Main.master" Title="Approve Teller Account" AutoEventWireup="true" CodeFile="ApproveTellerBankAccount.aspx.cs" Inherits="ApproveTellerBankAccount" %>
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h4>Check for Teller Accounts Pending Approval
                                </h4>
                                <ol class="breadcrumb">
                                    <li>
                                    ...
                                    <li class="active">
                                        <i class="fa fa-edit"></i>Approve Accounts
                                    </li>
                                </ol>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <asp:Button ID="btnApprove" runat="server" OnClick="btnApprove_Click"
                                                CssClass="btn btn-primary" Text="Approve Accounts(s)" />
                                            <asp:Button ID="btnReject" runat="server" OnClick="btnReject_Click"
                                                CssClass="btn btn-danger" Text="Reject Account(s)" />
                                        </div>
                                        <div class="col-lg-4"></div>
                                    </div>
                                    <hr />
