<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="ReversePayments.aspx.cs" Inherits="ReversePayments" Title="VIEW PAYMENT FOR REVERSAL" %>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <asp:MultiView runat="server" ID="Multiview2">
                            <asp:View runat="server" ID="resultView">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <asp:Button ID="btnConvert" runat="server" OnClick="btnReverse_Click"
                                            CssClass="btn-primary" Text="Reverse Transaction(s)" />
                                    </div>
                                    <div class="col-lg-4"></div>
                                </div>
                                <hr />
                                           ...
                                           <AlternatingRowStyle BackColor="#BFE4FF" />
                                            <Columns>
                                                <asp:TemplateField HeaderText="Reverse">
                                                    <HeaderTemplate >
                                                        <asp:CheckBox ID="chkboxSelectAll" Text="ReverseAll" runat="server" AutoPostBack="true" OnCheckedChanged="dataGridResults_SelectedIndexChanged" />
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                        ...
                        <script type="text/javascript" language="javascript">
                            ...
                            {
                                var GridVwHeaderChckbox = document.getElementById("<%=dataGridResults.ClientID %>");
