...
public partial class ApproverBankCustomer : System.Web.UI.Page
{
    BankUser user;
    ...
    private void ApproveUser(GridViewRow row)
    {
        ...
        Result result = bll.UpdateCustomerIsActiveStatus(parameters);
    ...
    private void SearchDB()
    {
        ...
        DataTable dt = bll.SearchBankCustomersTable(parameters);
        if (dt.Rows.Count > 0)
        {
    ...
    private void RejectUser(GridViewRow row)
    {
        ...
        {
            SearchDB();
            string msg = "Customer(s) Rejected Successfully";
            bll.ShowMessage(lblmsg, msg, false, Session);
        }
        else
        {
