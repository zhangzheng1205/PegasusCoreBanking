...
public partial class CreditBankVault : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                string msg = "SUCCESS: Bank Credited Successfully. Transaction ID [" + result.PegPayId + "]";
